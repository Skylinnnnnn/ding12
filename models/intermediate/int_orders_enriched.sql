-- Orders enriched with customer geography and reporting date/flag helpers.
...
select
    ...
    date_trunc('week',  orders.order_purchased_at)::date as order_week,

    -- Simple lifecycle flags for downstream aggregation
